...
class RespondentsControllerTest < ActionController::TestCase
  ...
  test "should create respondent" do
    assert_difference('Respondent.count') do
      post :create, respondent: { answer_time: @respondent.answer_time, member_id: @respondent.member_id, state_id: @respondent.state_id, subject_id: @respondent.subject_id }
    end
  ...
  test "should update respondent" do
    patch :update, id: @respondent, respondent: { answer_time: @respondent.answer_time, member_id: @respondent.member_id, state_id: @respondent.state_id, subject_id: @respondent.subject_id }
    assert_redirected_to respondent_path(assigns(:respondent))
  end
